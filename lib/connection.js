...
module.exports = (function () {
    ...
    var defaults = {
        ...
        ensureDB = function (database) {
            ...
            server.list().then(function (dbs) {
                //see of database we are looking to connect to is created
                //else create new
        ...
        //get database oriento db object
    ...
    /*Makes sure that all the collections are synced to database as classes*/
